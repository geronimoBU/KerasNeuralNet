...
# Hyper-parameters
# Different Hyperparameters - https://towardsdatascience.com/epoch-vs-iterations-vs-batch-size-4dfb9c7ce9c9
BATCH_SIZE = 400
EPOCHS = 5
...
y_pred_test = model_m.predict(df_test['x_axis'])
